...
define('POSTVIEWS_FOR_WP_VERSION','1.0.2');
...
require_once plugin_dir_path( __DIR__ ).'post-views-for-wp/admin/postviews-admin-settings.php';
...
function setter_PostViews($postID) {
   ...
   if ( $options['post_v_forwp_field_IP_Filter'] == 0 ) {
    ...
    return $pv_forwp_html.$pvlabel_val.' : '.$count.$pv_forwp_htmlend;
}
